...
<body>
    ...
    <div class="jumbotron jum" style="background-color: #212529;text-align: center;">
        ...
        <div class="row">
            ...
            $sql = "SELECT * FROM $db->contactTable  where user_id='$user_id' and trash='1' ";
            $result = $db->query($sql);
                        ...
                        ?>
                            <tr>
                                <th style="text-align: center;">
                                    <form id="removeForm" method="POST" action="ajax.php?action=rutr"><input id="remove" name="id" type="hidden" class="" value="<?php echo $state['id']; ?>"> <button type="submit" name="submitRemove" class="btn btn-danger"><?php echo REMOVE; ?> </button></form>

                                </th>
                                <th style="text-align: center;">
                                    <form id="restoreUser" method="POST" action="ajax.php?action=resu"> <input id="resUserId" name="resUserId" type="hidden" class="" value="<?php echo $state['id']; ?>"><button type="submit" name="restoreUser" class="btn btn-success"> <?php echo RESTORE; ?> </button></form>
                                </th>
    ...
    <script src="js/RestoreUser.js"></script>
